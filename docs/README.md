...
- S3 Endpoint - Frontend: http://yttn2-udagram.s3-website.us-east-2.amazonaws.com/
- Elastic Beanstalk URL - Backend: http://api-udagram.us-east-1.elasticbeanstalk.com/
